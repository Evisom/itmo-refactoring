...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        NimbusJwtDecoder decoder = NimbusJwtDecoder.withJwkSetUri("http://keycloak:8080/realms/boobook/protocol/openid-connect/certs")
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // Используем нашу конфигурацию CORS
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/library/find", "/api/v1/library/books/**").permitAll() // Публичные endpoints v1
                        .requestMatchers("/api/v2/books", "/api/v2/books/**").permitAll() // Публичные endpoints v2
