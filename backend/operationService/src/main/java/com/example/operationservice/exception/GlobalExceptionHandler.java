...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleResourceNotFound(
    ...
    ErrorResponse error =
        new ErrorResponse(ex.getErrorCode(), ex.getMessage(), request.getRequestURI());
  ...
  public ResponseEntity<ErrorResponse> handleBookNotFound(
    ...
    ErrorResponse error =
        new ErrorResponse("BOOK_NOT_FOUND", ex.getMessage(), request.getRequestURI());
    return ResponseEntity.status(HttpStatus.NOT_FOUND).body(error);
  }

  @ExceptionHandler(BookCopyNotFoundInLibraryException.class)
  public ResponseEntity<ErrorResponse> handleBookCopyNotFound(
      BookCopyNotFoundInLibraryException ex, HttpServletRequest request) {
    log.error("Book copy not found: {}", ex.getMessage(), ex);
    ErrorResponse error =
        new ErrorResponse("BOOK_COPY_NOT_FOUND", ex.getMessage(), request.getRequestURI());
    return ResponseEntity.status(HttpStatus.NOT_FOUND).body(error);
  }

  @ExceptionHandler(BookNotAprrovedYetException.class)
  public ResponseEntity<ErrorResponse> handleBookNotApproved(
      BookNotAprrovedYetException ex, HttpServletRequest request) {
    log.error("Book not approved: {}", ex.getMessage(), ex);
    ErrorResponse error =
        new ErrorResponse("BOOK_NOT_APPROVED", ex.getMessage(), request.getRequestURI());
    return ResponseEntity.status(HttpStatus.CONFLICT).body(error);
  }

  @ExceptionHandler(BookAlreadyExistException.class)
  public ResponseEntity<ErrorResponse> handleBookAlreadyExist(
      BookAlreadyExistException ex, HttpServletRequest request) {
    log.error("Book already exists: {}", ex.getMessage(), ex);
    ErrorResponse error =
        new ErrorResponse("BOOK_ALREADY_EXISTS", ex.getMessage(), request.getRequestURI());
    return ResponseEntity.status(HttpStatus.CONFLICT).body(error);
  }
  ...
  public ResponseEntity<ErrorResponse> handleIllegalArgument(
    ...
    ErrorResponse error =
        new ErrorResponse("ILLEGAL_ARGUMENT", ex.getMessage(), request.getRequestURI());
    return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(error);
  }
