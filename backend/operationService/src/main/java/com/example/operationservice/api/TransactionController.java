...
public class TransactionController {
  ...
  public ResponseEntity<BookTransactionResponse> reservBook(
      @PathVariable Long id, @Valid @RequestBody TransactionCreateRequest request) {
  ...
  public ResponseEntity<BookTransactionResponse> declineRequest(
